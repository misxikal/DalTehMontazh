(function ($) {
    ...
    wp.renovalcustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                renoval_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.renovalcustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.renovalcustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.renovalcustomizerRepeater.iconPickerToggle($(this));
        });
