 ...
 *
 * @package     Renoval
 * @copyright   Copyright (c) 2022, Renoval
 * @since       1.0
 */
...
class Renoval_Icon_Picker_Control extends WP_Customize_Control
{

  private $icons = false;

  public function __construct( $manager, $id, $args = array(), $options = array() ) {
    $this->icons = $this->Renoval_get_icons();
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'fonticonpicker-css', RENOVAL_PARENT_URI . '/assets/fonticonpicker/jquery.fonticonpicker.min.css', false );
			 
		wp_enqueue_script( 'fonticonpicker-js', RENOVAL_PARENT_URI .'/assets/fonticonpicker/jquery.fonticonpicker.min.js', array( 'jquery', 'jquery-ui-sortable' ) );
	}
  ...
  public function render_content() {
    if ( ! empty( $this->icons ) ) { ?>
      <label>
        ...
        <select <?php $this->link(); ?> style="font-family: 'FontAwesome', Arial;" class="contact-icon-picker iconPicker">
          <?php
